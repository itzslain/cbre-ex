...
namespace CBRE.Editor.UI
{
    public class Camera3DViewportListener : IViewportEventListener, IMediatorListener
    {
        ...
        public void UpdateFrame(FrameInfo frame)
        {
            ...
            decimal seconds = (frame.Milliseconds - currMillis) / 1000m;
            decimal units = CBRE.Settings.View.ForwardSpeed * seconds;
            ...
            if (CBRE.Settings.View.TimeToTopSpeed > 0)
            {
                decimal downFor = (frame.Milliseconds - _downMillis) / CBRE.Settings.View.TimeToTopSpeed;
            ...
            bool ignore = KeyboardState.IsAnyKeyDown(Keys.ShiftKey, Keys.ControlKey, Keys.Alt);
        ...
        private void SetFreeLook()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    bool req = CBRE.Settings.View.Camera3DPanRequiresMouseClick;
        ...
        private void MouseMoved(ViewportEvent e, int dx, int dy)
        {
            ...
            {
                // Camera
                decimal fovdiv = (Viewport.Width / 60m) / 2.5m;
        ...
        public void MouseWheel(ViewportEvent e)
        {
            ...
            Camera.Advance((e.Delta / Math.Abs(e.Delta)) * CBRE.Settings.View.MouseWheelMoveDistance);
        }
