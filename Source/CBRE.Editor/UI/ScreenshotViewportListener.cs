...
namespace CBRE.Editor.UI
{
    public class ScreenshotViewportListener : IViewportEventListener
    {
        ...
        {
            Screenshot?.Dispose();
            Bitmap bmp = new Bitmap(Viewport.ClientSize.Width, Viewport.ClientSize.Height);
            BitmapData data = bmp.LockBits(Viewport.ClientRectangle, ImageLockMode.WriteOnly, System.Drawing.Imaging.PixelFormat.Format24bppRgb);
