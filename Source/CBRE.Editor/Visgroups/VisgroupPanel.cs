...
namespace CBRE.Editor.Visgroups
{
    public partial class VisgroupPanel : UserControl
    {
        ...
        {
            List<Visgroup> visgroups = DocumentManager.CurrentDocument != null
        ...
        private void AddNode(TreeNode parent, Visgroup visgroup, Func<Visgroup, string> getCheckState)
        {
            ...
            TreeNode node = new TreeNode(visgroup.Name)
            {
            ...
            foreach (Visgroup vg in Sort(visgroup.Children))
            {
        ...
        public void Update(Document document)
        {
            ...
            Dictionary<int, string> states = document.Map.WorldSpawn
                .FindAll()
            ...
            foreach (Visgroup v in Sort(document.Map.Visgroups))
            {
        ...
        {
            Clear();
            foreach (Visgroup v in Sort(visgroups))
            {
        ...
        {
            TreeNode selected = VisgroupTree.SelectedNode;
            int? id = selected == null ? (int?)null : (int)selected.Tag;
            return id;
        }
        ...
        {
            TreeNode node = GetNodeForVisgroupID(visgroupId);
